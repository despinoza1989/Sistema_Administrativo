...
from .views import home, login, registro_cliente, registro, registro_profesional, listado_profesionales, listado_clientes, registro_administrativo, agendar_visita_terreno, desactivar_usuario
from .views import ListarUsuariosActivos
